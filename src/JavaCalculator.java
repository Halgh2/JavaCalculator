...
public class JavaCalculator {
    ...
    private double totalOne = 0.0;
    private double totalTwo = 0.0;
    private char math_operator;

    private void getOperator (String btnText) {
        math_operator = btnText.charAt(0);
        totalOne = totalOne + Double.parseDouble(textDisplay.getText( ) );
        textDisplay.setText("");
    }
        ...
        btnEquals.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                switch ( math_operator ) {
                    case '+':
                        totalTwo = totalOne + Double.parseDouble(textDisplay.getText( ) );
                        break;
                    case '-':
                        totalTwo = totalOne - Double.parseDouble(textDisplay.getText( ) );
                        break;
                ...
                textDisplay.setText(Double.toString(totalTwo));
                totalOne = 0;
            }
        });
        ...
        btnNeg.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if(textDisplay.getText().equals("")){
                    ...
                    Double x = -1 * Double.parseDouble(textDisplay.getText());
                    textDisplay.setText(Double.toString(x));
                }
            }
        });
